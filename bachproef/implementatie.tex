...
Bevindingen van zowel SAST als fuzzing gebruiken hetzelfde \texttt{Finding}-model met een vaste set velden: \texttt{rule\_id}, \texttt{severity}, \texttt{tool\_name}, \texttt{title} en \texttt{detail}. Dit maakt het mogelijk om bevindingen uit beide modules uniform te sorteren en te exporteren.
