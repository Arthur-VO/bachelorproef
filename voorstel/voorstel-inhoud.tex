...
In dit hoofdstuk wordt de werkwijze uiteengezet die gehanteerd wordt om de onderzoeksvraag te beantwoorden: \emph{"Hoe kan een geautomatiseerd security assessment framework ontworpen worden voor MCP-server implementaties?"} Het onderzoek betreft een \textbf{ontwerpgerichte studie} (design science research) waarbij de ontwikkeling van een technisch artefact (het security framework) centraal staat. Dit wordt gecombineerd met een vergelijkende studie om de effectiviteit te toetsen.
...
\textbf{Tools:} Zotero voor referentiebeheer, LaTeX voor documentatie. \\
